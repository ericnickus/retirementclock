...
const now = new Date();
    ...
    const changeBackground = (bg) => {
      document.getElementById("mainback").style.backgroundImage = "url(./images/" + bg + ".png)";
    };

    return (
        <div className="mainback" id="mainback" style={{backgroundImage: `url("./images/retireback1.png")`}}>
